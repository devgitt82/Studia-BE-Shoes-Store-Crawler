...
class SpiderSpider(scrapy.Spider):
    ...
    def parse(self, response):        
        ...
        for category in all_categories:
            ...
            if category_name == 'OFERTA' or category_name == 'DISCOUNT' or category_name == 'DESCRIPTION' or category_name == 'OUTLET' or category_name == 'KONTAKT' or category_name == 'CONTACT':           
                continue           
            yield {
